...
def _stage1_components(row: dict[str, str], weights: dict | None = None) -> dict[str, float]:
    ...
    sp_avg_prob_at_class = _to_float(row.get("sp_avg_prob_at_class"))
    ...
    return {
        ...
        "sp_similar_grade": max(-1.5, min(1.5, _pos_scale(sp_best_prob_similar, center=0.10, divisor=0.15, missing=0.0))) * w.get("sp_similar_grade", 0.0) * _sp_final_mult,
        ...
        "sp_reliability": (sp_reliability_rate or 0.0) * w.get("sp_reliability", 0.25) * _sp_final_mult,
